...
import 'package:flutter_cinema/presentation/widgets/slide_to_delete/fractionnally_aligned_sized_box.dart.dart';
import 'package:flutter_cinema/presentation/widgets/slide_to_delete/slidable_dismissal.dart.dart';

const double _kActionsExtentRatio = 0.1;
  ...
  Widget build(BuildContext context) {
    ...
    if (!(!widget.enabled ||
      ...
      content = GestureDetector(
        ...
        onTap: widget.canTap ? _onTap : null,
        child: content,
      );
    }
    ...
    return _SlidableScope(
      ...
      child: SlidableData(
        ...
        totalActionsExtent: _actionCount * 0.21,
