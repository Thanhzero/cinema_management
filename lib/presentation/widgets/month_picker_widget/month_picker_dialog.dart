...
import 'package:flutter_cinema/presentation/widgets/month_picker_widget/src/MonthSelector.dart';
import 'package:flutter_cinema/presentation/widgets/month_picker_widget/src/YearSelector.dart';
import 'package:flutter_cinema/presentation/widgets/month_picker_widget/src/common.dart';
import 'package:flutter_cinema/presentation/widgets/month_picker_widget/src/locale_utils.dart';
...
class _MonthPickerDialogState extends State<_MonthPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Dialog(
        insetPadding: EdgeInsets.all(LayoutConstants.paddingHorizontal / 2),
        child: Column(
